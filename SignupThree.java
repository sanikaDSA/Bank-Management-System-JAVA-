...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        pnumber.setBounds(330, 300, 240, 30);
        add(pnumber);
        
        JLabel pindetails = new JLabel("Your 4 Digit Password");
        pindetails.setFont(new Font("Raleway",Font.BOLD, 12));
        pindetails.setBounds(330, 330, 300, 20);
        add(pindetails);
        ...
        c7 = new JCheckBox("I Hereby declares that the above entered details sre correct to the best of my knowledge..");
        ...
        submit.setBounds(420, 600, 80, 30);
        ...
        cancel.setBounds(550, 600, 80, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        if (ae.getSource() == submit) {
            ...
            if (r1.isSelected()){
                ...
                accountType = "Fixed Depoit Account";
            }else if (r3.isSelected()){
                accountType = "Current Account";
            }else if (r4.isSelected()){
                accountType = "Reccuring Depoit Account";
            }
