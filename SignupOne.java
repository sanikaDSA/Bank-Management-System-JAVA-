...
public class SignupOne extends JFrame implements ActionListener {
    ...
    JButton next;
    JRadioButton male, female, other, marrige, unmarrige;
    ...
    SignupOne(){
        ...
        add(marital);
         ...
         marrige = new JRadioButton("Married");
        marrige.setBounds(300, 350, 100, 30);
        marrige.setBackground(Color.WHITE);
        add(marrige);
        
        unmarrige = new JRadioButton("Unmarried");
        unmarrige.setBounds(450, 350, 100, 30);
        unmarrige.setBackground(Color.WHITE);
        add(unmarrige);
        
        other = new JRadioButton("Other");
        other.setBounds(650, 350, 100, 30);
        other.setBackground(Color.WHITE);
        add(other);
        
        ButtonGroup marrigegroup = new ButtonGroup();
        marrigegroup.add(marrige);
        marrigegroup.add(unmarrige);
        marrigegroup.add(other);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String marital = null;
        if (marrige.isSelected()) {
            gender = "Married";
         } else if (unmarrige.isSelected()) {
             gender = "Unmarried";
        ...
        try{
           ...
           String query = "insert into signup(formno,name, fname,dob,gender,email,marital,address,city,state,pin)"+" values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pin+"','"+state+"')";
